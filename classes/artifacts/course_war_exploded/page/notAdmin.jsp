...
<div class="main auto clearfix">
  ...
  <div class="tit" style="margin: 5px; padding: 10px;">
    <div class="tit_l">
      <div class="tit_l_tit"><fmt:message key="sys.title.notAdmin"/></div>
    </div>
    <span style="font-size: 14px;"><span></span><font color="red"><span id="totalSecond">3</span></font><fmt:message
        key="sys.title.backToHome"/></span>
  </div>
