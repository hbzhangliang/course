...
<c:set var="projectImageFolder" value="${base}/web-resources/resources/skin/project/images"/>
<!--header start-->
<div class="header-bg">
    ...
    <div class="login-1">
      <dl>
        <c:if test="${currentUser==null}">
          <dt><input name="" type="image" src="${projectImageFolder}/home-bt.png"
                     onclick="location.href='${base}'">
          </dt>
          <dt><input name="" type="image" src="${projectImageFolder}/login.png"
                     onclick="location.href='${base}/loginWin.htm?from=${currentSection==null?currentHome.code:currentSection.code}'">
          </dt>
          <dt><input name="" type="image" src="${projectImageFolder}/index_05.png"
        ...
        <c:if test="${currentUser!=null}">
          ...
          <dt class="pt5">
            <a href="${base}/sys/module/prorep.htm" class="nav1"><fmt:message key="website.label.prorep"/></a>
          </dt>
          <dt class="pt5">
