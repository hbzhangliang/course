...
<%-- 	          	<c:import url="help/showSiteChoose.jsp"></c:import> --%>
      ...
      <table id="corplimitInfo" class="table_list t_hs">
      	<tr>
      		<td class="td1" width="10%">当前年份</td>
      		<td class="td2" width="8%"><label></label></td>
      		<td class="td1" width="10%">单位名称</td>
      		<td class="td2" width="8%"><label>${bean.corp.unitName}</label></td>
      		<td class="td1" width="10%">已使用数量(张数)</td>
      		<td class="td2" width="8%"><label></label></td>
      		<td class="td1" width="10%">已使用金额(元)</td>
      		<td class="td2" width="8%"><label></label></td>
      		<td class="td1" width="10%">余额(元)</td>
      		<td class="td2" width="8%"><label></label></td>
      	</tr>
      </table>
