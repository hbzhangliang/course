      ...
      <c:forEach items="${list}" var="bean" varStatus="i">
        <tr id="tr_${bean.id}">
          ...
          <td>
            ...
            <c:if test="${isAdmin}">
              <a href="javascript:void(0)" onclick="ajaxUpdate('${bean.id}','published',${!bean.published})">
