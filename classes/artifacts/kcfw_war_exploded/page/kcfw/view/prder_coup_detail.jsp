      ...
      <table border="0" cellspacing="0" cellpadding="0" class="table_list t_hs">
        ...
        <tr>
         ...
         <tr>
        	...
        	<td class="td2" colspan='3'>
        		<form:checkboxes path="corp.funcInfo" items="${lookups_FWJG}" itemLabel="lName" itemValue="lCode" disabled="true"/>
        		<form:label path="corp.funcOther">${corp.funcOther}</form:label>
        	</td>
        </tr>
         <tr>
