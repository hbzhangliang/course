        ...
        <table border="0" cellspacing="0" cellpadding="0" class="table_list t_hs">
            <tr>
                ...
                <td class="td2">
                    ...
                    <script id="editor1" type="text/plain" style="width:600px;height:300px;"></script>
...
<script>
    function doacceptApplySave(){
        doSubmit();
        parent.window.location.href=base+ "/deptReport/InnovReport/input.htm?cxCaterotyCode=acceptApply&op=g";
    }
